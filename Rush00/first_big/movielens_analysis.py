...
class Movies:
    ...
    def dist_by_release(self): # сортировка фильмов по году выпуска
        """
    ...
    def dist_by_genres(self): # сортировка фильмов по жанрам
        """
    ...
    def most_genres(self, n): # топ-n фильмов по жанрам
        """
    ...
    @lru_cache(maxsize=1024*1024*64)
...
class Links:
    ...
    @lru_cache(maxsize=1024*1024*128)
    ...
    def get_imdb(self, list_of_movies, list_of_fields): # получения списка параметров фильма с сайта
        """
    ...
    def top_directors(self, n): # топ-n режиссёров по количеству фильмов
        """
    ...
    def most_expensive(self, n): # топ-n фильмов по бюджету на создание
        """
        The method returns a dict with top-n movies where the keys are movie titles and
    ...
    def most_profitable(self, n): # топ-n фильмов по прибыли
        """
        The method returns a dict with top-n movies where the keys are movie titles and
    ...
    def longest(self, n): # топ-n фильмов по продолжительности
        """
        The method returns a dict with top-n movies where the keys are movie titles and
    ...
    def top_cost_per_minute(self, n): # топ-n фильмов по стоимости одной минуты экранного времени
        """
        The method returns a dict with top-n movies where the keys are movie titles and
...
class Statistics:
    ...
    Statistics utils
    """
    def average(values: list): # среднее значение - вспомогательная функция
        """
        Get average value of values list
        """
        return sum(values) / len(values)

    def median(values: list): # медиана - вспомогательная функция
        """
    ...
    def variance(values: list):  # разброс оценок (дисперсия) - вспомогательная функция
        """
...
class Tags:
    ...
    def most_words(self, n): # топ-n фильмов по количеству ключевых слов (тэгов)
        """
    ...
    def longest(self, n): # топ-n ключевых слов (тэгов) по длине
        """
    ...
    def most_words_and_longest(self, n): # топ-n фильмов по количеству и длине ключевых слов (тэгов)
        """
    ...
    def most_popular(self, n): # топ-n ключевых слов (тэгов) по популярности
        """
    ...
    def tags_with(self, word): # список уникальных ключевых слов, содержащих аргумент, переданный в функцию 
        """
